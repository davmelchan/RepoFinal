    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                ...
                <form method="POST" id="formulario" action="{{route('Estudiante.EvidenciaSave')}}"  enctype="multipart/form-data">
                    ...
                    <div class="form-group" hidden>
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="IdEmpresa" name="IdEmpresa" value="{{ $resultado->idEmpresa}}">
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                <button type="button" id="btnGuardar" onclick="guardarGrupo('{{route('Estudiante.EvidenciaSave')}}')" class="btn btn-primary">Guardar</button>
