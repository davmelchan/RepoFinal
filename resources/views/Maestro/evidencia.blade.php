        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-center mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Grupos de prácticas de formación profesionales</h1>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p>
                                            ...
                                            @if($grupo->GruposMaestro->Estado==1)
                                                <b>Estado: </b> Activo
                                            @endif</p>
                                        <a href="{{url('/Evidencialistado/'.$grupo->IdGrupo)}}" class="btn btn-unan btn-block">Seleccionar
                                            Grupo</a>
                                    </div>
                                </div>
                            </div>
