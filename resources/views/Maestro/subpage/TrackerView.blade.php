    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <h1 class="h3 mb-2 text-center text-gray-800">Actividades del alumno  <strong>{{$estudiante->Nombres}} {{$estudiante->Apellidos}}</strong></h1>
                                ...
                                @foreach($Actividades as $actividad)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{route('ViewEvidencia',['id'=>$estudiante->Identificacion,'idActividad'=>$actividad->IdTracker])}}" class="btn btn-success btn-icon-split">
